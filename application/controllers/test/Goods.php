...
class Goods extends MY_Controller
{
	...
	function index(){
		...
		$this->load->load_template('test/goods', $data);
	}
	...
	function ajaxGetGoods(){
		...
		if (empty($arrGoods)) {
			json_code(-1, array(), "商品异常");
		}
		json_code(1, $arrGoods, 'success');
	}
