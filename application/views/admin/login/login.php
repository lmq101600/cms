...
<div class="content">
	...
	<div class="form-group">
		...
		<input class="form-control form-control-solid placeholder-no-fix" name="code" type="text" placeholder="验证码" style='width:50%;'/>
		<div class="form-control form-control-solid placeholder-no-fix" style='width:50%;margin-left: 50%;margin-top: -43px;' id="div-verifyCode"></div>
	</div>
	...
	if ($isDis) :
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">验证码</label>
			<input class="form-control form-control-solid placeholder-no-fix" style='width:50%;margin-left: 200px;margin-top: -43px;' type="password" autocomplete="off" placeholder="code" name="code"/>
		</div>
	<?php endif;
...
<!--	</div>-->
	<div class="form-actions">
		<button type="submit" class="btn btn-primary btn-block uppercase" style="color: white">Login</button>
	</div>
<!--	<div class="form-actions">-->
<!--	  <div class="pull-left">-->
...
//            });
        $.ajax({
            ...
            success:function (result){
                console.log(result)
                $("#div-verifyCode").html(result.data.image);
            },
            error:function(){
                alert('error');
