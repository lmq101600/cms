						...
						if (!empty($list)) {
							...
							foreach ($list as $key => $value) {
								...
								<tr>
									...
									<td><button aid="<?php echo $value['id'];?>" class="btn blue-hoki btn-xs changeuserinfo"><i class="fa fa-edit"></i> 修改用户信息</button></td>
									<td><button aid="<?php echo $value['id'];?>" class="btn purple btn-xs changepwd"><i class="fa fa-lock"></i> 修改密码</button></td>
									<td>
										<?php if($value['user_level'] != 4) {?>
											<a class="btn blue-madison btn-xs" href="/admin/user/editright?id=<?php echo $value['id'];?>">
												<i class="fa fa-edit"></i>
												查看编辑</a>
										<?php } ?>
									</td>
									<td><button aid="<?php echo $value['id'];?>" class="btn btn-danger delete btn-xs"><i class="fa fa-trash-o"></i>删除</button></td>
								</tr>
								<?php
							}
						}
...
<div class="modal fade" id="edituser" tabindex="-1" role="basic" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="alert alert-warning" style="padding: 14px;"></div>
			...
			<div class="modal-body form-horizontal">
                <form>
                    ...
                    <div class="form-group">
                        <div class="col-md-3">
                            <label for="control-label">密码</label>
                        </div>
                        <div class="col-md-9">
                            <input type="password" name="pwd" class="form-control input-inline input-medium" placeholder="6位以上的字母或数字组成">
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="col-md-3">
                            <label for="control-label">昵称</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="nick_name" class="form-control input-inline input-medium" placeholder="6位以上的字母或数字组成">
                        </div>
                    </div>
					<?php
					if(!empty($arrlevel))
